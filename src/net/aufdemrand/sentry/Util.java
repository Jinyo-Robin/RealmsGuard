...
public class Util {
    ...
    public static void chatGood(Player p, String message) {
        p.sendMessage(ChatColor.DARK_AQUA + "[" + ChatColor.AQUA + "Natum" + ChatColor.DARK_AQUA + "] " + ChatColor.WHITE + message);
    }

    public static void chatBad(Player p, String message) {
        p.sendMessage(ChatColor.DARK_RED + "[" + ChatColor.RED + "Natum" + ChatColor.DARK_RED + "] " + ChatColor.WHITE + message);
    }

    public static void chatWarn(Player p, String message) {
        p.sendMessage(ChatColor.DARK_RED + "[" + ChatColor.RED + "Natum" + ChatColor.DARK_RED + "] " + ChatColor.WHITE + message);
    }

    public static void chat(Player p, String message) {
        p.sendMessage(ChatColor.GOLD + "[" + ChatColor.YELLOW + "Natum" + ChatColor.GOLD + "] " + ChatColor.WHITE + message);
    }

    public static void chatNormal(Player p, String message) {
        p.sendMessage(ChatColor.GOLD + "[" + ChatColor.YELLOW + "Natum" + ChatColor.GOLD + "] " + ChatColor.WHITE + message);
    }

    public static void chatEmote(Player p, String message) {
        p.sendMessage(ChatColor.DARK_PURPLE + "<" + ChatColor.LIGHT_PURPLE + message + ChatColor.DARK_PURPLE + ">");
    }
